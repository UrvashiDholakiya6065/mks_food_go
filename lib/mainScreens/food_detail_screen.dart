...
//             GestureDetector(
//               onTap: (){
//                 print("Printed Image ${widget.foodImage}");
//                 bool alreadyAdded = false;
//                 for (int i = 0; i < cartList.length; i++) {
//                   if (cartList[i]['foodName'] == widget.foodName) {
//                     alreadyAdded = true;
//                     break;
//                   }
//                 }
...
//                   borderRadius: BorderRadius.circular(20),
//                 ),
//                 child: Center(child: Text("ADD TO CART",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),),
//               ),
//             ),
//           ],
//         ),
